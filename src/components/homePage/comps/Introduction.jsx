...
const ImageOverlay = styled.div`
  ...
  right: 0;
  bottom: 0;
  background-color: rgba(0, 0, 0, 0.3); // 검은색 오버레이의 불투명도를 조절할 수 있습니다.
...
const slideContent = [
  {
    ...
    summary: "백신 접종부터 미용, 정기 검진까지 반려동물의 중요 일정을 관리하세요.",
    buttonText: "더보기"
  },
              ...
              return (
                <StyledSlide key={index}>
                  ...
                  <IntroTextWrapper>
                    ...
                    <SubscribeButton>{content.buttonText}</SubscribeButton>
                  </IntroTextWrapper>
                </StyledSlide>
              );
            })}
